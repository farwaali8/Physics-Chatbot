...
import { BoltIcon, AcademicCapIcon,CalculatorIcon, } from '@heroicons/react/24/outline'
...
export default function MyHome() {
 ...
 />
              ...
              <Link
                ...
                < Link
                   href ="/login" className="text-sm font-semibold leading-6 text-white">
        ...
        <div className="mx-auto  max-w-7xlnpm px-6 sm:mt-0.5 lg:px-8">
